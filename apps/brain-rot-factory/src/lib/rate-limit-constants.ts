...
export const RATE_LIMIT_MESSAGES = {
  ...
  ANONYMOUS_REMAINING: (remaining: number, limit: number) =>
  ...
  USER_REMAINING: (remaining: number, limit: number) =>
    `${remaining} of ${limit} daily generations remaining. More ways to get additional generations coming soon!`,
} as const
